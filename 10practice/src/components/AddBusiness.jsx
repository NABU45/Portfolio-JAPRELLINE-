...
function AddBusiness() {
  ...
  return (
    <div className="w-screen h-screen bg-slate-900">
         <div className="flex flex-col h-full p-3 w-60 bg-slate-900">
                <div className="space-y-3">
                    <div className="flex items-center justify-between text-white">
                        <h2 className="font-bold">JAPRELLINE</h2>
                    ...
                    <div className="relative">
                        ...
                        <input type="search" name="Search" placeholder="Search..." className=" w-full py-2 pl-10 text-sm border-transparent rounded-md focus:outline-none bg-gray-100 text-gray-800 focus:bg-gray-50"
                        />
                    </div>
                        ...
                        <ul className="pt-2 pb-4 space-y-1 text-sm  text-white">
                            <li className="rounded-sm  ">
                                <a href="#" className="flex items-center p-2 space-x-3 rounded-md">
                                    ...
                                    <span ><button onClick={() => setNewModelOpen(true)}>Open Model</button></span>
                ...
                <div className="flex items-center p-2 mt-12 space-x-4 justify-self-end">
                    <img
                        src="https://scontent.fktm17-1.fna.fbcdn.net/v/t39.30808-6/414095727_386575800608958_6318288145526292166_n.jpg?_nc_cat=107&ccb=1-7&_nc_sid=5f2048&_nc_ohc=HttL8afjHEwAb7jdkvE&_nc_ht=scontent.fktm17-1.fna&oh=00_AfBGCQZRG4rKVsBanUdRMwVi62y9QqceAaCQxw5vrYgDnw&oe=662476A2"
                        alt=""
                        className="w-12 h-12 rounded-lg" />
                    <div>
                        <h2 className="text-lg font-semibold  text-white">Leroy Jenkins</h2>
                        <span className="flex items-center space-x-1">
                            <a href="#" className="text-xs hover:underline text-white">View profile</a >
                        </span>
                    </div>
                </div>
            </div>   
                  
           <div className={`inset-0 fixed h-screen flex justify-center items-center transition-all  ${newModelOpen? ' visible':'invisible' } 
          `}>
           <div className={`h-[90%] w-[30%]  rounded-lg shadow-lg  transition-all bg-white  ${newModelOpen? 'scale-900':'scale-1'} 
           ${newModelOpen?'translate-x-500':'translate-y-10'} px-6 py-8` }>

          <div className="flex flex-row justify-between items-center ">
            <span className="font- bold text-xl ">Add a Business</span>
            <RxCross2  size={20}  color="gray" onClick={() => setNewModelOpen(false)}/>
          </div>
          <div className="my-5  w-full border-b-2 border-rose-500 rounded-full"></div>
          ...
          <button className="px-2 py-1 text-rose-500 rounded-md font-bold text-lg border-2 border-rose-500 hover:bg-red-500 hover:text-white" onClick={() => setNewModelOpen(false)}>Cancel</button>

          <button className="px-2 py-1 bg-rose-500 rounded-md font-bold text-white  text-lg border-2 border-rose-500  hover:bg-white hover:text-rose-500  hover:translate-all " >Submit</button>
          </div>
