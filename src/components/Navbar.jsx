  ...
  return (
    <>
        ...
        <nav  className="h-screen w-1/3 justify-start bg-slate-900">
          ...
          <ul className="text-white font-bold text-md justify-center py-10 flex flex-col gap-5">
            ...
            <li className="flex gap-7 px-[30%]">
              ...
              <button onClick={() => setContact(true)} className="text-sm">Contact Us</button>
            </li>
            <li className="flex gap-7 px-[30%]">
      ...
      <div   onClick={closeModals} className={`h-screen inset-0 fixed flex justify-center items-center transition-all ${about ? "visible" : "invisible"}`}>
        <div onClick={(e) => e.stopPropagation()}  className={`h-[90%] w-[50%] rounded-lg shadow-lg ml-[30%] transition-all bg-slate-200 ${about ? "scale-1 translate-y-10" : "scale-900 translate-x-500"} px-0 py-4`}>
          ...
          <div className="my-4 w-full border-b-2 border-blue-600 rounded-full"></div>
          <About />
        </div>
      </div>
