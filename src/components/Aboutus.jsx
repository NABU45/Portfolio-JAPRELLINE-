...
const About = () => {
  ...
  return (
    <>
      <div className="m-auto max-w-6xl px-6 py-2 max-h-2xl">
        <div className="flex flex-col md:flex-row">
          <div className="md:w-1/2 max-w-md flex flex-col justify-center">
            <div className="md:text-4xl text-xl uppercase font-black">
          ...
          <div className="flex md:justify-end w-full md:w-1/2 -mt-5">
            <div className="bg-dots">
              <div className="shadow-2xl max-w-sm z-10 mt-1 ml-4 justify-center">
                {nabin ? (
                  <img
                    alt="Nabin Japrel"
