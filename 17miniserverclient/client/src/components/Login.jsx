...
function Login() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            toast.success("Login successfully. You will be redirected in 3 seconds..");
              ...
              <form action="/" method="POST">
                <div className="flex flex-col mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input onChange={handelEmailChange} value={email} id="email" type="email" name="email" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="E-Mail Address" />
                  </div>
                </div>
                <div className="flex flex-col mb-6">
                  ...
                  <div className="relative">
                    ...
                    <input onChange={handelPasswordChange} value={password} id="password" type="password" name="password" className="text-sm sm:text-base placeholder-gray-500 pl-10 pr-4 rounded-lg border border-gray-400 w-full py-2 focus:outline-none focus:border-blue-400" placeholder="Password" />
                  </div>
                </div>
                ...
                <div className="flex w-full">
                  ...
                  onClick={handleSubmit}
                   type="submit" className="flex items-center justify-center focus:outline-none text-white text-sm sm:text-base bg-blue-600 hover:bg-blue-700 rounded py-2 w-full transition duration-150 ease-in">
